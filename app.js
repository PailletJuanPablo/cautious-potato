...
app.get('/inicio', (req, res) => devolverVista( res, 'views/index.html'));
app.get('/contactarnos', (req, res) => devolverVista( res, 'views/contacto.html'));
app.get('/about', (req, res) => devolverVista( res, 'views/nosotros.html'));
